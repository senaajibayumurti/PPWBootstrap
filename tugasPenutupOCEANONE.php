            ...
            <div class="container">
                ...
                <div class="col-md-9 mx-auto">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form onsubmit="submitForm(event)" action="save.php">
                        ...
                        <script>
                            function submitForm(event) {
                                ...
                                if (name === "" || email === "") {
                                    ThxText.innerText = "";
                                    AfterThxTextFalse.innerText = "Name and Email cannot be empty!";
                                } else {
                                    ...
                                    xhr.onreadystatechange = function () {
                                        if (xhr.readyState === 4 && xhr.status === 200) {
                                            ...
                                            AfterThxTextFalse.innerText = "Failed to insert data. Please try again.";
                                        }
